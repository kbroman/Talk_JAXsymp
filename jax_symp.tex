...
\\[2pt]
\scriptsize {\lolit Slides:} \href{https://kbroman.org/JAXsymp}{\tt
  \color{foreground} kbroman.org/JAXsymp}
}
...
Slides: \href{https://kbroman.org/JAXsymp}{\tt kbroman.org/JAXsymp} \quad
